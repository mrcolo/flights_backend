...
{
    airline_name = a_name; airline_iata = a_iata;
    source_name = s_name; source_iata = s_iata;
    source_lat = s_lat; source_lng = s_lng;
    destination_name = d_name; destination_iata = d_iata;
    destination_lat = d_lat; destination_lng = d_lng;
    distances_mi = dis; times_hr = hrs;
}
